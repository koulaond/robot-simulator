...
class PlaygroundTest {
    ...
    void validatePosition_positionIsOutOfX() {
        ...
        Assertions.assertThrows(IllegalStateException.class, () ->
                playground.validatePosition(Position.builder().xPos(5).yPos(0).build()));
    }
    ...
    void validatePosition_positionIsOutOfY() {
        Playground playground = Playground.getInstance();
        Assertions.assertThrows(IllegalStateException.class, () ->
                playground.validatePosition(Position.builder().xPos(0).yPos(5).build()));
    }
    ...
    void validatePosition_positionIsUnderX() {
        Playground playground = Playground.getInstance();
        Assertions.assertThrows(IllegalStateException.class, () ->
                playground.validatePosition(Position.builder().xPos(-1).yPos(0).build()));
    }
    ...
    void validatePosition_positionIsUnderY() {
        Playground playground = Playground.getInstance();
        Assertions.assertThrows(IllegalStateException.class, () ->
                playground.validatePosition(Position.builder().xPos(0).yPos(-1).build()));
    }
}